 ...
 * initializing all samplers with the same seed, it is ensured that all
...
int main() {
  ...
  test_numerical_equality<double>(theta_phi_single_1[0], theta_phi_z_axis[1][0],
                                  epsilon);
  test_numerical_equality<double>(theta_phi_single_1[1], theta_phi_z_axis[1][1],
                                  epsilon);
  ...
  test_numerical_equality<double>(theta_phi_single_1_rotated[1],
