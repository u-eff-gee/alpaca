 ...
 *
 * J. M. Hammersley, Table of Complete Elliptic Integrals, J. Res. Nat. Bur.
 * Stand. 50 (1953) 43.
 *
 * In that reference, the parameter \f$k^{-1}\f$ is tabulated, which is related
 * to \f$m\f$ by:
 *
 * \f[
 ...
 * \f]
 *
 * In particular, the literature values for the elliptic integral of the second
