...
int main() {
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(em_unknown, 2, magnetic, 4, 0.), State(2, negative)},
  ...
  try {
    AngularCorrelation ang_corr(
        ...
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, negative)},
         {Transition(em_unknown, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, em_unknown, 4, 0.), State(2, negative)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, negative)},
         {Transition(electric, 2, em_unknown, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, parity_unknown)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, negative)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, parity_unknown)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(magnetic, 4, electric, 6, 0.), State(2, negative)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, negative)},
  ...
  AngularCorrelation ang_corr(
      State(0, positive),
      {{Transition(electric, 10, electric, 2, 0.), State(2, negative)},
       {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(magnetic, 2, magnetic, 4, 0.), State(2, negative)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, positive)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(magnetic, 4, magnetic, 6, 0.), State(4, positive)},
         {Transition(electric, 4, magnetic, 6, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, negative)},
         {Transition(magnetic, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, electric, 4, 0.), State(2, negative)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(2, negative)},
         {Transition(electric, 2, electric, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr(
        State(0, positive),
        {{Transition(electric, 2, magnetic, 4, 0.), State(1, negative)},
         {Transition(electric, 2, magnetic, 4, 0.), State(0, positive)}});
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr_0_1_0{
        State(0, parity_unknown),
        {State(0, negative), State(0, parity_unknown)}};
  } catch (const std::invalid_argument &e) {
    error_thrown = true;
  }
  ...
  try {
    AngularCorrelation ang_corr_0_1{State(0, parity_unknown),
                                    {
                                        State(2, negative),
                                    }};
  } catch (const std::invalid_argument &e) {
  ...
  AngularCorrelation ang_corr_0_1_0{State(0, positive),
                                    {State(2, negative), State(6, negative)}};
  ...
  AngularCorrelation ang_corr_3_5_3_9 = AngularCorrelation{
      State(3, positive),
      {State(5, parity_unknown), State(3, negative), State(9, negative)}};
  ...
  AngularCorrelation ang_corr_0_4_4 = AngularCorrelation{State(0, positive),
                                                         {
                                                             State(4, positive),
                                                             State(4, positive),
                                                         }};
  ...
  AngularCorrelation ang_corr_0_4m_4 =
      AngularCorrelation{State(0, positive),
                         {
                             State(4, negative),
                             State(4, positive),
                         }};
