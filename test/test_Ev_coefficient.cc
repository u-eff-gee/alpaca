...
int main() {
  ...
  // which is independent of delta is positive. Equations (I-8) and (I-9) in
  // \cite FaggHanna1959 show that the sign of the same term is positive as
  // well, i.e. no additional sign is needed here.
  //
  ...
  // indeed, 'the + or - sign is to be employed according as the ... is electric
  // or magnetic in character' \cite FaggHanna1959 means that 'electric' and +
  // belong together.
