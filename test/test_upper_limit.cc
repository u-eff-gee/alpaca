...
vector<W_gamma_gamma *> ang_corrs{
    // // 0 -> 1 -> 0
    new W_dir_dir(State(0, parity_unknown),
    ...
    new W_pol_dir(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, positive)},
         {Transition(em_unknown, 2, em_unknown, 4, 1.),
          State(2, parity_unknown)}}),
    new W_pol_dir(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, positive)},
    ...
    new W_pol_dir(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, positive)},
         {Transition(em_unknown, 2, em_unknown, 4, 100.),
          State(2, parity_unknown)}}),
    ...
    new W_pol_dir(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, positive)},
         {Transition(em_unknown, 4, em_unknown, 6, 1.),
          State(6, parity_unknown)}}),
    new W_pol_dir(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, positive)},
    ...
    new W_pol_dir(
        State(0, positive),
        {{Transition(magnetic, 2, electric, 4, 0.), State(2, positive)},
         {Transition(em_unknown, 4, em_unknown, 6, 100.),
          State(6, parity_unknown)}}),
    ...
    // 1/2 -> 5/2 -> 1/2
    new W_dir_dir(State(1, parity_unknown),
                  {{Transition(em_unknown, 4, em_unknown, 6, 0.),
    ...
    // 3/2 -> 3/2 -> 3/2
    new W_dir_dir(State(3, parity_unknown),
                  {{Transition(em_unknown, 2, em_unknown, 4, 0.),
    ...
    // 5/2 -> 3/2 -> 5/2
    new W_dir_dir(State(5, parity_unknown),
                  {{Transition(em_unknown, 2, em_unknown, 4, 0.),
                    State(3, parity_unknown)},
                   {Transition(em_unknown, 2, em_unknown, 4, 0.),
                    State(5, parity_unknown)}}),
